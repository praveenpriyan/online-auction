...
while ($i<$row)
{
$id=mysql_result($qry,$i,"idea_id");
$date=mysql_result($qry,$i,"date");
$staff_id=mysql_result($qry,$i,"Staff_ID");
$name=mysql_result($qry,$i,"Email");
$brch=mysql_result($qry,$i,"Branch");
$topic=mysql_result($qry,$i,"Topics");
$idea=mysql_result($qry,$i,"Description");
$count=mysql_result($qry,$i,"comment");
?>
    <tr>
